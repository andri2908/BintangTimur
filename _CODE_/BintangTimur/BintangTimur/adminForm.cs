...
namespace AlphaSoft
{
    public partial class adminForm : Form
    {
        ...
        private void activateUserAccessRight()
        {
            ...
            setAccessibility(globalConstants.MENU_STOK_TRANSFER, MENU_transferStok);
            // SUB MENU MUTASI
        ...
        private void MENU_SORevision_Click(object sender, EventArgs e)
        {
        ...
        private void stokGlobaltoolStripMenuItem14_Click(object sender, EventArgs e)
        {
            DS.mySqlConnect();
            string sqlCommandx = "";
