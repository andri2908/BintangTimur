...
INSERT INTO `master_module` VALUES (1,'MANAJEMEN SISTEM',NULL,1,1),(2,'DATABASE',NULL,1,1),(3,'MANAJEMEN USER',NULL,3,1),(4,'MANAJEMEN CABANG',NULL,3,0),(5,'SINKRONISASI INFORMASI',NULL,1,1),(6,'PENGATURAN PRINTER',NULL,1,1),(7,'PENGATURAN GAMBAR LATAR',NULL,1,1),(8,'GUDANG',NULL,1,1),(9,'PRODUK',NULL,1,1),(10,'TAMBAH / UPDATE PRODUK',NULL,3,1),(11,'PENGATURAN HARGA PRODUK',NULL,1,1),(12,'PENGATURAN LIMIT STOK',NULL,1,1),(13,'PENGATURAN KATEGORI PRODUK',NULL,1,1),(14,'PECAH SATUAN PRODUK',NULL,1,1),(15,'PENGATURAN NOMOR RAK',NULL,1,1),(16,'KATEGORI PRODUK',NULL,3,1),(17,'SATUAN PRODUK',NULL,1,1),(18,'TAMBAH / UPDATE SATUAN',NULL,1,1),(19,'PENGATURAN KONVERSI SATUAN',NULL,1,1),(20,'STOK OPNAME',NULL,1,1),(21,'PENYESUAIAN STOK',NULL,1,1),(22,'MUTASI BARANG',NULL,1,0),(23,'TAMBAH / UPDATE MUTASI BARANG',NULL,3,0),(24,'CEK PERMINTAAN BARANG',NULL,1,0),(25,'PENERIMAAN BARANG',NULL,1,1),(26,'PENERIMAAN BARANG DARI MUTASI',NULL,1,1),(27,'PENERIMAAN BARANG DARI PO',NULL,1,1),(28,'PEMBELIAN',NULL,1,1),(29,'SUPPLIER',NULL,1,1),(30,'REQUEST ORDER',NULL,3,0),(31,'PURCHASE ORDER',NULL,3,1),(32,'REPRINT REQUEST ORDER',NULL,1,1),(33,'RETUR PEMBELIAN KE SUPPLIER',NULL,1,1),(34,'RETUR PERMINTAAN KE PUSAT',NULL,1,0),(35,'PENJUALAN',NULL,1,1),(36,'PELANGGAN',NULL,3,1),(37,'TRANSAKSI PENJUALAN',NULL,1,1),(38,'SET NO FAKTUR',NULL,1,1),(39,'RETUR PENJUALAN',NULL,1,1),(40,'RETUR PENJUALAN BY INVOICE',NULL,1,1),(41,'RETUR PENJUALAN BY STOK',NULL,1,0),(42,'KEUANGAN',NULL,1,1),(43,'PENGATURAN NO AKUN',NULL,3,1),(44,'TRANSAKSI',NULL,1,1),(45,'TAMBAH TRANSAKSI HARIAN',NULL,1,1),(46,'PEMBAYARAN PIUTANG',NULL,1,1),(47,'PEMBAYARAN PIUTANG MUTASI',NULL,1,0),(48,'PEMBAYARAN HUTANG KE SUPPLIER',NULL,1,1),(49,'PENGATURAN LIMIT PAJAK',NULL,1,1),(50,'MODUL MESSAGING',NULL,1,1),(51,'TAX_MODULE',NULL,1,1),(52,'SALES QUOTATION',NULL,1,1),(53,'APPROVAL SALES QUOTATION',NULL,1,1),(54,'PRE ORDER SALES',NULL,1,1),(200,'MODUL LAPORAN',NULL,1,1),(201,'LAPORAN PEMBELIAN BARANG',NULL,1,1),(202,'LAPORAN HUTANG AKAN JATUH TEMPO',NULL,1,1),(203,'LAPORAN HUTANG LEWAT JATUH TEMPO',NULL,1,1),(204,'LAPORAN PEMBAYARAN HUTANG',NULL,1,1),(205,'LAPORAN PENJUALAN PRODUK',NULL,1,1),(206,'LAPORAN OMZET PENJUALAN',NULL,1,1),(207,'LAPORAN TOP SALE',NULL,1,1),(208,'LAPORAN PENJUALAN KASIR',NULL,1,1),(209,'LAPORAN KEUANGAN',NULL,1,1),(210,'LAPORAN PIUTANG AKAN JATUH TEMPO',NULL,1,1),(211,'LAPORAN PIUTANG LEWAT JATUH TEMPO',NULL,1,1),(212,'LAPORAN PEMBAYARAN PIUTANG',NULL,1,1),(213,'LAPORAN DEVIASI STOK',NULL,1,1),(214,'LAPORAN STOK DIBAWAH LIMIT',NULL,1,1),(215,'LAPORAN RETUR BARANG',NULL,1,1),(216,'LAPORAN MUTASI BARANG',NULL,1,0),(217,'LAPORAN PEMBAYARAN MUTASI',NULL,1,0);
...
CREATE TABLE `sales_header` (
  ...
  `IS_PREORDER` tinyint(3) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
