...
INSERT INTO `master_category` VALUES (3,'BESI PLAT','BESI PLAT',1);
...
INSERT INTO `master_group` VALUES (1,'GLOBAL_ADMIN','GLOBAL ADMIN GROUP',1),(2,'NORMAL USER','NORMAL USER',1),(3,'GUDANG','DIVISI GUDANG',1);
...
INSERT INTO `master_product` VALUES (6,'1',NULL,'BETON ESER','PLAT 1.2X2.4',200000,250000,215000,235000,'1.jpg',6,20,10,'--00',1,'YK',0);
...
INSERT INTO `master_unit` VALUES (6,'LEMBAR','UKURAN 1.2X2.4',1);
...
INSERT INTO `master_user` VALUES (1,'ADMIN','admin','ADMIN','1',1,1),(2,'ARISTONHS','ariston','ARISTON HENDRO SAPUTRO','08123141412',1,2);
...
INSERT INTO `product_location` VALUES (1,1,'1',10),(2,2,'1',10);
...
INSERT INTO `user_access_management` VALUES (19,1,0,0);
...
-- Dump completed on 2016-03-28  9:34:52
